...
using Capa_Controlador_Comercial;   //Agregar para usar la bitácora
...
namespace PrototipoPrincipal
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //Mostrar Splash
            using (var splash = new Capa_Vista_Comercial.Frm_Slash())
            {
                splash.ShowDialog();
            }

            //Esto muestra el Login después
            Application.Run(new Capa_Vista_Comercial.Frm_Modulos());
        }
