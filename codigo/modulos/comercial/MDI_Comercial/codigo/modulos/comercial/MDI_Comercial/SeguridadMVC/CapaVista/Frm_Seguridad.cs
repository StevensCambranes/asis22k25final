...
namespace Capa_Vista_Comercial
{
    public partial class Frm_Seguridad : Form
    {
        ...
        public void fun_habilitar_botones_por_permisos_combinados(int iIdUsuario, int iIdPerfil)
        {
            ...
            {
                {4406, navegadorToolStripMenuItem},
            ...
            foreach (DataRow row in dtPermisosUsuario.Rows)
            {
                int idModulo = Convert.ToInt32(row["iFk_id_modulo"]);
                int idAplicacion = Convert.ToInt32(row["iFk_id_aplicacion"]);
                if (idModulo == 9 && idAplicacion >= 4401 && idAplicacion <= 4406)
                {
                    if (mapaCatalogos.ContainsKey(idAplicacion))
                        mapaCatalogos[idAplicacion].Enabled = true;
                    if (mapaProcesos.ContainsKey(idAplicacion))
        ...
        private void inventarioToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ctrlBitacora.RegistrarAccion(
                ...
                4405,
                "Ingresó al submódulo de Inventario",
                true   // sigue logueado
            );
        }
        ...
        private void comprasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ctrlBitacora.RegistrarAccion(
                Cls_Usuario_Conectado.iIdUsuario,
                4401,
                "Ingresó al submódulo de Compras",
                true   // sigue logueado
            );
        }
        ...
        private void cuentasPorPagarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ctrlBitacora.RegistrarAccion(
                Cls_Usuario_Conectado.iIdUsuario,
                4403,
                "Ingresó al submódulo de Cuentas por Pagar",
                true   // sigue logueado
            );
        }
        ...
        private void ventasFacturasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ctrlBitacora.RegistrarAccion(
                Cls_Usuario_Conectado.iIdUsuario,
                4402,
                "Ingresó al submódulo de Ventas y Facturas",
                true   // sigue logueado
            );
        }
        ...
        private void cuentasPorCobrarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ctrlBitacora.RegistrarAccion(
                Cls_Usuario_Conectado.iIdUsuario,
                4404,
                "Ingresó al submódulo de Cuentas por Cobrar",
                true   // sigue logueado
            );
        }
        ...
        {
            Frm_PruebaNavegador irNavegador = new Frm_PruebaNavegador();
            irNavegador.Show();
        }
    }
}
