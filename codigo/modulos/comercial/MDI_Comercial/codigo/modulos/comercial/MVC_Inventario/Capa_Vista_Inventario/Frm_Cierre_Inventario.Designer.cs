...
namespace Capa_Vista_Inventario
{
    partial class Frm_Cierre_Inventario
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Pnl_Principal_Cierre.Controls.Add(this.Lbl_Abonos_Acumulados);
            this.Pnl_Principal_Cierre.Controls.Add(this.Lbl_Cargos_Mes_Producto);
            this.Pnl_Principal_Cierre.Controls.Add(this.Txt_Saldo_Inicial_Producto);
            this.Pnl_Principal_Cierre.Controls.Add(this.Lbl_Saldo_Inicial);
            this.Pnl_Principal_Cierre.Controls.Add(this.Txt_Saldo_Final);
            this.Pnl_Principal_Cierre.Controls.Add(this.Txt_Abono_Mes);
            this.Pnl_Principal_Cierre.Controls.Add(this.Txt_Abono_Acumulado);
            this.Pnl_Principal_Cierre.Controls.Add(this.Txt_Cargos_Acumulados);
            this.Pnl_Principal_Cierre.Controls.Add(this.Txt_Cargos_Mes);
